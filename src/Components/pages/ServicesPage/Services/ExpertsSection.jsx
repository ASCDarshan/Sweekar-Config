import { Avatar, Box, Button, Chip, Container, Divider, Grid, Paper, Rating, Typography } from "@mui/material";
                                ...
                                <Box sx={{ mt: 1, display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                    {expert.specializations.map((spec, index) => (
                                        <Chip
                                            ...
                                            size="small"
                                            sx={{
                                                bgcolor: `${selectedService.color}15`, color: selectedService.color,
                                            }}
                                        />
                                    ))}
                                </Box>
